...
class DumpGenerator:
    ...
    def __insert_events(cursor):
        cursor.execute(
            """
                    INSERT INTO event (name, genre_name, impresario_id, building_id) VALUES
                            ('Последний вздох', 'Драма', 1, 1),
                            ('Вставай', 'Комедия', 2, 2),
                            ('Ее след', 'Романтика', 3, 3),
                            ('Отличник с личной жизнью', 'Фантастика', 4, 4),
                            ('Астрал', 'Мистика', 5, 5),
                            ('Пара по психологии', 'Комедия', 6, 1),
                            ('Щелкунчик', 'Балет', 7, 2),
                            ('Лебединое озеро', 'Балет', 8, 3),
                            ('Рад вас видеть', 'Комедия', 9, 4),
                            ('Кошки', 'Мюзикл', 10, 5),
                            ('Спящая красавица', 'Балет', 11, 1),
                            ('Wall-e', 'Анимация', 12, 2),
                            ('Дон Кихот', 'Балет', 13, 3),
                            ('Баядерка', 'Балет', 14, 4),
                            ('Жизель', 'Балет', 15, 5);
                        """
        )
